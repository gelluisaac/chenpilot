...
describe("MemoUtils", () => {
  describe("isValidMemoHash", () => {
    ...
    it("should throw for null or undefined", () => {
      expect(() => isValidMemoHash(null)).toThrow(MemoValidationError);
      expect(() => isValidMemoHash(undefined)).toThrow(MemoValidationError);
    });
  });
  ...
  describe("buildHashMemo", () => {
    ...
    it("should throw for invalid input type", () => {
      expect(() => buildHashMemo(123)).toThrow(MemoValidationError);
      expect(() => buildHashMemo({})).toThrow(MemoValidationError);
    });
  });
  ...
  describe("validateMemo", () => {
    ...
    it("should throw for null memo", () => {
      expect(() => validateMemo(null)).toThrow(MemoValidationError);
      expect(() => validateMemo(null)).toThrow("Memo cannot be null or undefined");
    });
  ...
  describe("memoToHex", () => {
    ...
    it("should throw for non-hash/return memo types", () => {
      ...
      expect(() => memoToHex(memo)).toThrow(MemoValidationError);
      expect(() => memoToHex(memo)).toThrow(
